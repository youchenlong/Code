...
def get_model():
    model = tf.keras.models.Sequential([
        tf.keras.layers.Dense(units=120, activation="relu", kernel_regularizer="l2"),
        # tf.keras.layers.Dropout(rate=0.5),
        tf.keras.layers.Dense(units=84, activation="relu", kernel_regularizer="l2"),
        # tf.keras.layers.Dropout(rate=0.5),
