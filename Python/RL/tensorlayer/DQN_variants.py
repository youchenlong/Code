...
python DQN_variants.py --train --disable_dueling --noisy_scale=0 --env_id=CartPole-v1
python DQN_variants.py --train --disable_double --noisy_scale=0 --env_id=CartPole-v1
python DQN_variants.py --train --disable_double --disable_dueling --env_id=CartPole-v1

python tutorial_DQN_variants.py --train --disable_double --disable_dueling --noisy_scale=0 --env_id=BreakoutNoFrameskip-v4
"""
import argparse
import os
import random
...
parser.add_argument('--disable_dueling', action='store_true')
