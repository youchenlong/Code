...
python DQN_PER.py --train --env_id=MountainCar-v0
python DQN_PER.py --train --env_id=Breakout-v0
"""
import argparse
import operator
import os
...
prioritized_replay_alpha = 0.1  # alpha in PER
prioritized_replay_beta0 = 1.0  # initial beta in PER
